#!/usr/bin/env bun
/**
 * founderclaw-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   founderclaw-global-discover --since 7d [--format json|summary]
 *   founderclaw-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: founderclaw-global-discover --since <window> [--format json|summary]
...
Examples:
  founderclaw-global-discover --since 7d
  founderclaw-global-discover --since 14d --format summary`);
}
...
function resolveClaudeCodeCwd(
  ...
  // e.g., -Users-ashish797-git-repo → /Users/ashish797/git/repo
