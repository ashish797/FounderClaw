...
- Save the report to .founderclaw/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.founderclaw', 'security-reports');
...
- Skip the preamble (founderclaw-update-check, telemetry, etc.) — go straight to the audit.
