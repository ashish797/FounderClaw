...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/founderclaw-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/founderclaw-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/founderclaw-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'gemini-review-findings': ['review/**', '.agents/skills/founderclaw-review/**', 'test/helpers/gemini-session-runner.ts', 'lib/worktree.ts'],


  // Coverage audit (shared fixture) + triage + gates
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/founderclaw-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/founderclaw-repo-mode'],
  ...
  // founderclaw-upgrade
  'founderclaw-upgrade-happy-path': ['founderclaw-upgrade/**'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/founderclaw-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/founderclaw-review-read'],
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // founderclaw-upgrade
  'founderclaw-upgrade-happy-path': 'gate',
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'founderclaw-upgrade/SKILL.md upgrade flow': ['founderclaw-upgrade/SKILL.md', 'founderclaw-upgrade/SKILL.md.tmpl'],
