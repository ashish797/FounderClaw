...
Branch: ashish797/agent-design-tools
...
5. $D serve writes board HTML with injected __FOUNDERCLAW_SERVER_URL
...
| HTML injection of server URL | __FOUNDERCLAW_SERVER_URL check | `serve.test.ts` |
